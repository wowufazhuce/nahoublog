...
const shareList = [
  {
    ...
    onClick: (data: ShareData) => {
      window.open(
        `https://service.weibo.com/share/share.php?url=${encodeURIComponent(data.url)}&title=${encodeURIComponent(data.text)}&appkey=`,
      )
    },
  },
  {
...
function DonateContent() {
  return (
    <motion.div
      className="bg-primary rounded-lg p-6 border border-primary"
